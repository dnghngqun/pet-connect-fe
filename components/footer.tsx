        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Mạng xã hội kết nối cộng đồng cứu hộ động vật, giúp tìm thú cưng
              thất lạc và tìm nhà cho những bé cần nhận nuôi.
            </p>
