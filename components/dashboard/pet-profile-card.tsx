...
export default function PetProfileCard({ pet }: PetProfileCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-[#232329] rounded-2xl shadow-soft p-6 flex flex-col items-center text-center relative overflow-hidden group">
      ...
      <Link href={`/pets/${pet.id}/profile`} className="relative z-10 cursor-pointer">
        <div className="w-28 h-28 rounded-full p-1 bg-white dark:bg-[#232329] shadow-sm mb-4 transition-transform hover:scale-105 duration-300">
          <div
      ...
      {/* Pet Info - Also Clickable */}
      <Link href={`/pets/${pet.id}/profile`} className="hover:underline">
      ...
      <div className="flex w-full gap-2">
        <div className="flex-1 flex flex-col items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5 cursor-pointer transition-colors">
          <span className="font-bold text-lg text-[#1b110d] dark:text-white">{pet.followerCount || pet.stats?.followers || 0}</span>
        ...
        <div className="flex-1 flex flex-col items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5 cursor-pointer transition-colors">
          <span className="font-bold text-lg text-[#1b110d] dark:text-white">{pet.postCount || pet.stats?.posts || 0}</span>
