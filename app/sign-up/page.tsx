      ...
      >
        <Card className="backdrop-blur-xl bg-white/90 dark:bg-gray-900/90 border-white/40 shadow-2xl">
          ...
          >
            ...
            <CardDescription className="mt-2">Nhập thông tin của bạn để tạo tài khoản</CardDescription>
          </motion.div>
        </CardHeader>
        <motion.form
        ...
        >
          ...
          <CardFooter className="flex flex-col">
            ...
            >
              Đã có tài khoản?{" "}
              <Link href="/sign-in" className="text-primary hover:underline font-semibold transition-colors">
                Đăng nhập
              </Link>
            </motion.div>
